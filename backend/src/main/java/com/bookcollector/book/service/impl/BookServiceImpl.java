package com.bookcollector.book.service.impl;
...
import com.bookcollector.book.service.BookService;
...
/**
 * {@link BookService} 的实现。
 *
 * <p>设计取舍（为什么在 {@code BookRepository} 之上再包一层、三条业务规则的由来）
 * 见 {@link BookService} 的类注释。
 */
@Service
